...
export const Default: Story = () => (
  <Panel>
    <eink-box style={{ flex_grow: 1, padding: 48 }}>
      <Text font_size={30}>380px tall, pinned to the bottom of the panel.</Text>
    </eink-box>
    <Keyboard />
  </Panel>
);
  ...
  return (
    <Panel>
      <eink-box style={{ flex_grow: 1, padding: 48, gap: 20 }}>
        <Text font_size={28}>Tap keys, or use the physical keyboard.</Text>
        <eink-box bg={255} border={2} border_color={0} style={{ height: 200, padding: 20 }}>
...
export const AboveAClueLine: Story = () => (
  <Panel>
    ...
    <eink-box bg={255} border={2} style={{ height: 76, justify_content: 'center', padding: [0, 60, 0, 60] }}>
